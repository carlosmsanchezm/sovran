...
function activate(ctx) {
    ...
    // Commands
    ctx.subscriptions.push(vscode.commands.registerCommand('aegis.showLogs', () => ui_1.out.show()), vscode.commands.registerCommand('aegis.disconnect', () => vscode.commands.executeCommand('workbench.action.closeWindow')), vscode.commands.registerCommand('aegis.connect', async (wid) => {
